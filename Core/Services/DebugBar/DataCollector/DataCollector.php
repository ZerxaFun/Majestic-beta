...
use Core\Services\DebugBar\DataFormatter\DataFormatter;
use Core\Services\DebugBar\DataFormatter\DataFormatterInterface;
...
abstract class DataCollector implements DataCollectorInterface
{
     ...
     *
     * @param DevDumper $varDumper
     */
    public static function setDefaultVarDumper(DevDumper $varDumper)
    {
    ...
    public static function getDefaultVarDumper()
    {
        if (self::$defaultVarDumper === null) {
            self::$defaultVarDumper = new DevDumper();
        }
     ...
     * @return $this
     */
    public function setVarDumper(DevDumper $varDumper)
    {

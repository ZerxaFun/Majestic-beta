...
class Theme extends AbstractTheme
{
     ...
     * @param mixed $var
     */
    public function set(string $name, mixed $var): void
    {
     ...
     * @return bool|string
     */
    public function get(string $mjt_name): bool|string
    {
        $mjt_name = str_replace(chr(0), '', $mjt_name);
     ...
     */
    public function load_file(array $matches = []): mixed
    {
        $name = $matches[1];
     ...
     * @return false|string
     */
    public function sub_load_template($mjt_name): bool|string
    {
        if ($mjt_name === '' || !file_exists($this->dir . $mjt_name )) {
